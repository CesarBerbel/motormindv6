...
const tabs = [
  ...
  { key: "extra", label: "Observações", description: "Status, legado e observações" },
];
...
export default function SuppliersPage() {
  ...
  function applyCompanyLookup(company) {
    update({
      ...
      document: company.document || form.document,
